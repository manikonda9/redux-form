...
class LoginReduxForm extends React.Component {
    ...
    render() {
        ...
        return (
            <form onSubmit={handleSubmit(this.submit)} className="container col-12 col-sm-8 col-md-3 col-lg-3">
                <h2>Login Form :</h2>
                <div className="form-group">
                    <label htmlFor="username" className="control-label">User Name :</label>
                    <Field name="username" className="form-control" component={renderField} placeholder="Enter User Name" type="text" />
                </div>
                <div className="form-group">
                    <label htmlFor="password" className="control-label">Password :</label>
                    <Field name="password" className="form-control" component={renderField} placeholder="Enter Password" type="password" />
                </div>
                <div className="form-group">
                    <button type="submit" disabled={pristine || submitting} className="btn btn-success float-right">Login</button>
                </div>
            </form>
        )
    }
